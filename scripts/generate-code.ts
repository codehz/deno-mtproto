...
class DefinitionProcessor {
  ...
  constructor() {
    ...
    jsfile.append`/// <reference types="./api.d.ts" />`;
    jsfile.append`// Generated by scripts/generate-code.ts`;
    tsfile.append`// Generated by scripts/generate-code.ts`;
...
await Deno.writeTextFile("gen/api.d.ts", processor.ts);
